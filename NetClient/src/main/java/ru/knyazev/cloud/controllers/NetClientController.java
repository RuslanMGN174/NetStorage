package ru.knyazev.cloud.controllers;
...
import ru.knyazev.cloud.model.*;
import ru.knyazev.cloud.network.Net;
...
@Slf4j
public class NetClientController implements Initializable {
    @FXML
